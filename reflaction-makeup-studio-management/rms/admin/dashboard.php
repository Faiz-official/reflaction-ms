...
<html>
<head>
<title>RMS Admin | Admin Dashboard</title>
	...
	<?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper" class="row calender widget-shadow">
			<div class="main-page">
				...
				<div class="row calender widget-shadow" style="padding: 1em 1.5em 1em;">
					<div class="row-one">
					<div class="col-md-4 widget">
						<?php $query1=mysqli_query($con,"Select * from tbluser");
$totalcust=mysqli_num_rows($query1);
?>
						<div class="stats-left " style="background-color: #1e9b28;">
							<h5>Total</h5>
							<h4>Customer</h4>
						</div>
						<div class="stats-right" style="background-color: rgba(73, 167, 69, 0.88);">
							<label > <a href="customer-list.php" style="color:#ffffff;"><?php echo $totalcust;?></a></label>
						</div>
...
?>
						...
						<div class="stats-right">
							<label><a href="all-appointment.php" style="color:#ffffff;"><?php echo $totalappointment;?></a></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
...
?>
						...
						<div class="stats-right">
							<label><a href="accepted-appointment.php" style="color:#ffffff;"><?php echo $totalaccapt;?></a></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="clearfix"> </div>	
...
?>
						...
						<div class="stats-right" style="background-color: rgba(73, 167, 69, 0.88);">
							<label><a href="rejected-appointment.php" style="color:#ffffff;"><?php echo $totalrejapt;?></a></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="col-md-4 widget states-mdl">
...
?>
						...
						<div class="stats-right">
							<label><a href="manage-services.php" style="color:#ffffff;"><?php echo $totalser;?></a></label>
						</div>
						<div class="clearfix"> </div>	
					</div>
					<div class="col-md-4 widget states-last">
