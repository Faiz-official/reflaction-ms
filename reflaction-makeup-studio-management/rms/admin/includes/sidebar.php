    ...
    <div class="navbar-collapse">
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
            <ul class="nav" id="side-menu">
                ...
                <!-- Slides Section -->
                <li>
                    <a href="add-slides.php"><i class="fa fa-book nav_icon"></i> Slides <span class="fa arrow"></span> </a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="add-slides.php">Add Slides</a></li>
                        <li><a href="manage-slides.php">Manage Slides</a></li>
                    </ul>
                </li>
                ...
                <!-- Other Sections -->
                <li><a href="customer-list.php"><i class="fa fa-users nav_icon"></i> Customer List</a></li>
                <li>
                    <a href="sales-reports.php"><i class="fa fa-check-square-o nav_icon"></i> Reports <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="bwdates-reports-ds.php"> B/w dates</a></li>
                        <li><a href="sales-reports.php">Sales Reports</a></li>
                    </ul>
                </li>
                <li><a href="invoices.php"><i class="fa fa-file-text-o nav_icon"></i> Invoices</a></li>
                <li><a href="search-appointment.php"><i class="fa fa-search nav_icon"></i> Search Appointment</a></li>
                <li><a href="search-invoices.php"><i class="fa fa-search nav_icon"></i> Search Invoice</a></li>
            </ul>
