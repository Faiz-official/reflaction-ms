...
<html>
<head>
<title>RMS Admin | B/W date Reports</title>
...
?>
<h5 align="center" style="color:darkred; font-size:20px; font-weight:bold;">Report from <?php echo $fdate?> to <?php echo $tdate?></h5><br>
